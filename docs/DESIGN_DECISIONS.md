...
| Robot | 2 × Franka Panda |
| Early active robot count | 1 |
...
The final scene contains two Franka Panda robot arms.
...
Only Panda 1 is active initially.

Panda 2 is present but inactive.
